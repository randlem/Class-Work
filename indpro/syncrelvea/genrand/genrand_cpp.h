...
public:
	...
	double randNum() {
		...
		if(nextRand >= listSize)
			expandRandList(listSizeInc);
	
		// return the next random number
		return(randList[nextRand++]);	
	}
...
//RandGenEngine::minListSize = 10;
//RandGenEngine::listSizeInc = 10;
