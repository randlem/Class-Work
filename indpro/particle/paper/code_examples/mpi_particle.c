...
BOOL set_x_pos_fnt(double (*x_pos_fnt)(particle*, float)) {
	if(x_pos_fnt == NULL) {
		return(FALSE);
	}
...
BOOL set_y_pos_fnt(double (*y_pos_fnt)(particle*, float)) {
	if(y_pos_fnt == NULL) {
		return(FALSE);
	}
...
BOOL set_z_pos_fnt(double (*z_pos_fnt)(particle*, float)) {
	if(z_pos_fnt == NULL) {
		return(FALSE);
	}
