...
$query2=("SELECT * FROM survey_questions WHERE ordno='$or_down' and surid='$surid'");
...
ordno='$or_down' WHERE ordno='$or' and surid='$surid'");
mysql_query($query1,$dbh);


$query3=("UPDATE survey_questions SET
ordno='$or' WHERE qno='$qno' and ordno='$or_down' and surid='$surid'");
