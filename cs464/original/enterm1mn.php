...
<input type="hidden" name=question value=<? echo $q ?>

<html>
<head>
<title>Enter num choices</title>
  ...
  <tr>
    ...
    <td valign="top">
      <table width="95%"  height=500 border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td>
<form name="form3" action=enter_choices.php method="POST">


   
        
        <div align="center">
          <p>Enter the Number of Choices: 
              <input name="des" cols="10"></p>


          
 </td></tr>
 <tr><td align=center><input type="submit" name="Submit" value="Enter Choices">
  </td></tr>
        <tr>
