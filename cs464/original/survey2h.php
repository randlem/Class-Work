...
<form name="form3" method="post" action="enterq3.php">
        ...
        <div align="center">
          ...
          <table width="428" height="90" border="0">
            <tr>
              <td width="172"><div align="center"><font size=4> Question: </font></div></td>
              <td width="246"> 
                  <div align="center">
                      <textarea name="question" cols="35"></textarea>
                  </div></td>
            </tr>
          </table>
          <p>&nbsp;</p>
          <table width="426" height="68" border="0">
            <tr>
              <td width="177"><div align="center"><font size=4><font size=4>Choose type of
Question:</font></div></td>
              ...
              <select name="kind">
                ...
                <option value="y/n">Yes or No</option>
                 <option value=""></option>
                <option value="multi1">Multiple Choice - Select
One</option>
