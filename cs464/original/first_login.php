...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="150">
<a href="auth_accpt.php"><img src="img120.JPG" width="200" height="100"></a></td>
    <td valign="top">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
  ...
  <tr>
    <td valign="top">
     ...
     <table width="95%"  height=700 border="0" cellspacing="0" cellpadding="0">
       ...
       <tr></tr>
	<tr></tr>
      <tr><td><div align=center><font size=6>
      Sorry!!!</font><br>
  <font size=4>
You have to Login First<br>
<a href="http://voyager.cs.bgsu.edu/pdevu/proj/login.htm">Click
here to login</a>
 <font></td></tr>
