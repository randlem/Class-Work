  ...
  <tr>
    ...
    <td valign="top">
      <table width="95%"  height=500 border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td>
<form name="form9" action=save.php method="POST">
<input type=hidden name=type value="multi1">
<div align="center">
<?
$no=$_POST['des'];
 for($p=1;$p<=$no;$p++)
...
?>
 ...
 <tr><td align=center><input type="submit" name="Submit" value=" Save Choices ">
  </td></tr>
        <tr>
