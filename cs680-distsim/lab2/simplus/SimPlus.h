...
class SimPlus
{
	public:
		...
		int getEventListSize() { return(theEventList->listSize()); }
		Event* getEvent();
		...
		WeibullDist* getWeibullDist(const double&, const double&, const RNGFactory::RNGType = (RNGFactory::RNGType)0);
		LogLogisticDist* getLogLogisticDist(const double&, const double&, const RNGFactory::RNGType = (RNGFactory::RNGType)0);
		TriangleDist* getTriangleDist(const double&, const double&, const double&, const RNGFactory::RNGType = (RNGFactory::RNGType)0);

		// discrete distributions
		BernoulliDist* getBernoulliDist(const double&, const RNGFactory::RNGType = (RNGFactory::RNGType)0);
		BinomialDist* getBinomialDist(const double&, const double&, const RNGFactory::RNGType = (RNGFactory::RNGType)0);
		PoissonDist* getPoissonDist(const double&, const RNGFactory::RNGType = (RNGFactory::RNGType)0);
