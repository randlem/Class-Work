...
class SimPlus
{
	public:
		...
		ExponentialRNG* getExponentialRNG( const double&,
			unsigned short = RawRNG::Local );
		NormalRNG* getNormalRNG( const double&, const double&,
			unsigned short = RawRNG::Local );
		UniformRNG* getUniformRNG( const double&, const double&,
			unsigned short = RawRNG::Local );
