...
// constants
const int minArySize = 1;   // minimum size of an array
const int maxArySize = 100; // maximum size of an array
...
private:
   ...
   public:
	  ...
	  long elseLoc;        // address of forward jump transfer vector (else end)
   };
